...
AGG_SALES_DAILY_PATH = f'{STAR_SCHEMA_PATH}/agg_sales_daily'
AGG_SALES_DAILY_BY_PRODUCT_PATH = f'{STAR_SCHEMA_PATH}/agg_sales_daily_by_product'
AGG_SALES_DAILY_BY_PRINCIPAL_PATH = f'{STAR_SCHEMA_PATH}/agg_sales_daily_by_principal'
